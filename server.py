...
class Server:
    ...
    def start_server(self):
        ...
        print(colored('[+] Running on host: '+str(self.host), 'green'))
        print(colored('[+] Running on port: '+str(self.port), 'green'))
        ...
        while True:
            ...
            print(colored('[+] New connection. Username: '+str(username), 'green'))           
            self.broadcast(colored(' New person joined the room. Username: '+username, 'green'))
...
##### Encrypt the secret with the client public key
    ...
    def send_secret(self,c,secret_key):
        try:
            c.send(secret_key)
            print(colored('[+] Symmetric sent to the client', 'green'))
...
##### Exchanging the public key with the client
    def send_pub_key(self, c):
        try:
            ...
            print(colored('[+] Client public key received', 'green'))
    ...
    def handle_client(self,c,addr):
        ...
        while True:
            ...
            if msg.decode() != '':
                ...
                print(colored('[+] '+ self.username_lookup[c] +' left the chat.', 'red'))
...
def terminate(Server):
    while True:
        ...
        if (command == 'TERMINATE'):
            ...
            print(colored('[+] All connections terminated', 'green'))
        break
    print(colored('[+] Server is shut down', 'green'))
    os._exit(0)
